...
class PlacementApiTest(unittest.TestCase):
    ...
    def test_csrf_password_logout_and_health(self):
        ...
        local=backend.app.test_client().post('/api/auth/login',json={'email':'student@test.com','password':'Changed-password-456'},headers={'Origin':'http://localhost:5173'});self.assertEqual(local.status_code,200)
